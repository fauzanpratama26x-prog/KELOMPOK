...
<head>
    ...
    <title>Toko Indonesia - Edit Supplier</title>
    ...
    <main class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="form-card">
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.suplier.update', $suplier->id_suplier) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       class="form-input"
                                       disabled>
                                <p class="form-hint">ID Supplier tidak dapat diubah</p>
                            </div>
