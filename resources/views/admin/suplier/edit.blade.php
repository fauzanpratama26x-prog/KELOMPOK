        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-slate-200">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-slate-900">Edit Supplier</h2>
                        <p class="mt-1 text-sm text-slate-600">Perbarui informasi supplier</p>
                    </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('admin.suplier.update', $suplier->id_suplier) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="mt-2 block w-full rounded-3xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-100"
                                   readonly>
                            <p class="mt-1 text-xs text-slate-500">ID tidak dapat diubah</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="telepon"
                                   id="telepon"
                                   value="{{ old('telepon', $suplier->telepon) }}"
                                   class="mt-2 block w-full rounded-3xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-100"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="kontak_person"
                                   id="kontak_person"
                                   value="{{ old('kontak_person', $suplier->kontak_person) }}"
                                   class="mt-2 block w-full rounded-3xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-emerald-500 focus:ring-emerald-100"
                                   required>
                        </div>
                    </div>
